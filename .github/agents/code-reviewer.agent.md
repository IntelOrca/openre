...
Record each thing to report in the TODO list and ensure they are all addressed before finishing.

## Things to report
- Avoid raw addresses. These should be declared somewhere. Constant or immutable data should be declared as named symbols at the top of the module. Mutable data should be added to address_map.txt and regenerated so it appears in the re2.h game table.
...
- The function should not contain any interop::* lines, they should have been replaced with a call to the appropriate stub/already decompiled function.
