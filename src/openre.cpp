...
namespace openre
{
    ...
    {
        interop::call<void, void*, const void*, size_t>(0x00502D50, dst, src, size);
    }
    ...
    {
        Memcpy(gGameTable.inventory_bk, gGameTable.inventory, sizeof(gGameTable.inventory_bk));
    ...
    static int card_write_save_file(int successState)
    {
        ...
        if ((int)file_write_save(gGameTable.save_path, &gGameTable.table_start, 0x800) <= 0)
        {
            ...
            {
                gGameTable.word_98E9BC--;
                Memcpy(gGameTable.inventory, gGameTable.inventory_bk, sizeof(gGameTable.inventory_bk));
    ...
    static void card_access()
    {
        ...
        case CARD_STATE_LOAD:
        {
            ...
            Memcpy(&gGameTable.table_start, gGameTable.p_card_work + 500, 0x798);
            load_pop();
