...
- [x] 0x00434AB0 SsSetVol (530)
- [x] 0x00434CF0 SsGetVolume (393)
...
- [x] 0x004EC450 Snd_load_core (639)
- [x] 0x004EC6D0 Snd_load_arms (252)
- [x] 0x004EC7D0 Snd_room_load (205)
- [x] 0x004EC8A0 Snd_load_em (231)
- [x] 0x004EC9C0 Snd_bgm_set (537)
- [x] 0x004ECBE0 Snd_bgm_ck (250)
- [x] 0x004ECCE0 Snd_bgm_play_ck (179)
- [x] 0x004ED050 Snd_bgm_sub (518)
- [x] 0x004ED260 Snd_bgm_fade_ON (137)
- [x] 0x004ED2F0 Snd_bgm_ctr (1558)
- [x] 0x004ED950 Snd_se_on (1241)
- [x] 0x004EDE30 Snd_se_enem (263) — implement in `src/enemy.cpp` (wrapper is there)
- [x] 0x004EDF40 Snd_se_walk (1032) — implement in `src/player.cpp` (wrapper is there)
- [x] 0x004EE350 Snd_se_call (230)
- [x] 0x004EE440 Snd_bgm_fade (814)
- [x] 0x004EE780 Snd_se_3D (1067)
- [x] 0x004EEBD0 Snd_se_dir_ck (82)
- [x] 0x004EEC30 Xa_play (145)
- [x] 0x004EECD0 Xa_stop (36)
- [x] 0x004EED00 Xa_control (14)
- [x] 0x004EED10 Xa_control_stop (25)
- [x] 0x004EED30 Xa_control_init (8)
- [x] 0x004EED40 Xa_control_play (59)
- [x] 0x004EED80 Xa_control_end (71)
- [x] 0x004EEDD0 Xa_set_volume (28)
- [x] 0x004EEDF0 Cd_system_control (15)
- [x] 0x004EEE00 SsSeqSetDecrescendo (50)
